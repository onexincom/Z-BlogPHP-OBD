...
//        if(isset($_POST['isdelimiter'])) $options['isdelimiter'] = (int)$_POST['isdelimiter'];
        if (isset($_POST['from_style2'])) {
            $options['from_style2'] = $_POST['from_style2'];
        }
        if (isset($_POST['portal_users'])) {
            $options['portal_users'] = $_POST['portal_users'];
        }
        if (isset($_POST['origviews'])) {
            $options['origviews'] = $_POST['origviews'];
        }
        if (isset($_POST['worktime'])) {
            $options['worktime'] = $_POST['worktime'];
        }
    ...
    if (bigdata_submitcheck('managesubmit')) {
        ...
        $res = (array) bigdata_htmlspecialchars($res);
    ...
    // stats page
    $_status = isset($_GET['status']) ? (int) $_GET['status'] : '';
    $_resid = (int) $_GET['resid'];
    ...
    if ($count) {
        ...
        $multi = bigdata_multi($count, $perpage, $page, $baseurl
