...
<div class="content-box container-fluid wrap">
    ...
    <ul class="nav nav-pills content-box-tabs">
      <li><a <?php if (!isset($_GET['status'])) {
            echo ' class="current"';
             }?> href="<?php echo $baseurl;?>"><?php echo __('Stats', 'onexin-bigdata'); ?></a></li>
      <li><a <?php if ($_GET['status'] == '0') {
            echo ' class="current"';
             }?> href="<?php echo $baseurl;?>&amp;status=0"><?php echo __('Standby List', 'onexin-bigdata'); ?></a></li>
      <li><a <?php if ($_GET['status'] == '1') {
            echo ' class="current"';
             }?> href="<?php echo $baseurl;?>&amp;status=1"><?php echo __('Posted', 'onexin-bigdata'); ?></a></li>
            ...
            <tbody>
              ...
              <tr id="post-<?php echo $value['bid'];?>">
                ...
                <td><div style="max-width:500px;">
                    ...
                    (<?php echo $value['ip'];?>)
                                            <?php } ?>
                    (<a href="<?php echo $baseurl;?>&amp;bid=<?php echo $value['bid'];?>"><?php echo $value['bid'];?></a>) <a href="<?php echo $value['url'];?>" target="_blank">
                                            <?php if ($value['name']) { ?>
